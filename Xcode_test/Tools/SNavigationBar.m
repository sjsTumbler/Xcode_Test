...
{
    CGSize titleSize = [parentName sizeWithAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:btnFontOfSize]}];//sizeWithFont:[UIFont systemFontOfSize:btnFontOfSize]];
    self.leftBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    self.leftBtn.frame = CGRectMake(15, 33,15+titleSize.width, 21);
    self.leftBtn.tag = nav_left_tag;
